<?php /*a:2:{s:65:"D:\phpstudy_pro\WWW\dcweb\app\shop\view\zhuohao\zhuohao\edit.html";i:1677136378;s:52:"D:\phpstudy_pro\WWW\dcweb\app\shop\view\layout2.html";i:1676699056;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-form" lay-filter="">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <div class="layui-col-md4">
                <input type="text" disabled  name="" value="<?php echo htmlentities($detail['number']); ?>"  placeholder="请输入终端号" class="layui-input">
            </div>
            <span>不可修改</span>
        </div>
    </div>
