<?php /*a:1:{s:57:"D:\phpstudy_pro\WWW\dcweb\app\admin\view\index\index.html";i:1676699056;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="layui-header">
        ...
        <ul class="layui-nav layui-layout-right">
            ...
            <li class="layui-nav-item">
                <a href="javascript:">
                    <cite><?php echo htmlentities($admin_name); ?>（<?php echo htmlentities($role_name); ?>）</cite>
...
<!--                    <dd><hr></dd>-->
    ...
    <div class="layui-body" id="LAY_app_body">
        <div lay-id="0" class="lay-tabsbody-item layui-show">
            <iframe src="<?php echo url('index/stat'); ?>" class="lay-iframe" name="view_frame"></iframe>
        </div>
    </div>
<script>
