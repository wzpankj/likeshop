<?php /*a:2:{s:59:"D:\phpstudy_pro\WWW\dcweb\app\admin\view\shop\auth\add.html";i:1676699056;s:53:"D:\phpstudy_pro\WWW\dcweb\app\admin\view\layout2.html";i:1676699056;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <select id="pid" name="pid" class="layui-select" lay-search>
                ...
                <?php if(is_array($menu_lists) || $menu_lists instanceof \think\Collection || $menu_lists instanceof \think\Paginator): $i = 0; $__LIST__ = $menu_lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
