...
class TakeoutOrderLogic extends Logic
{
    ...
    public static function lists($get = [], $shop_id)
    {
        ...
        $field = 'o.id,o.user_id,o.order_sn,o.order_status,o.create_time,o.total_num,o.dining_type,o.take_code,o.consignee,o.mobile,o.delivery_amount,(o.order_amount - o.delivery_amount) as goods_amount,o.order_amount,o.pay_way,o.pay_status,o.pay_time,o.order_type,o.transaction_id,o.address_snap,o.refund_amount,o.surplus_refund_amount,o.refund_status,o.refund_time';
    ...
    public static function exportFile($get,$shop_id)
    {
        ...
        $lists = Order::alias('o')
            ->field('o.id,o.user_id,o.order_sn,o.order_status,o.create_time,o.total_num,o.dining_type,o.take_code,o.consignee,o.mobile,o.delivery_amount,(o.order_amount - o.delivery_amount) as goods_amount,o.order_amount,o.pay_way,o.pay_status,o.pay_time,o.order_type,o.transaction_id')
            ->join('user u', 'u.id = o.user_id')
            ->join('order_goods og', 'og.order_id = o.id')
            ->with(['order_goods' => function($query){
                $query->field('order_id,goods_name,goods_num,goods_price,goods_snap')->json(['goods_snap'],true);
        ...
        $exportTitle = ['ID', '订单编号', '订单状态', '下单时间', '会员编号', '会员昵称', '商品信息', '商品数量', '收货方式', '收货人', '手机号码', '收货地址', '配送费用', '商品金额', '应付金额',
        ...
        foreach($lists as $item) {
            ...
            $exportData[] = [$item['id'], $item['order_sn'], $item['order_status_text'], $item['create_time'], $item['user']['sn'], $item['user']['nickname'], $goods_info, $item['total_num'], $item['dining_type_text'], $item['consignee'], $item['mobile'], $item['delivery_address'], $item['delivery_amount'], $item['goods_amount'], $item['order_amount'], $item['pay_way_text'], $item['pay_status_text'], $item['pay_time'], $item['transaction_id']];
        }
